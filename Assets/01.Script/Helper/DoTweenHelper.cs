...
public static class DoTweenHelper
{
    ...
    public static Tween MoveZ(this Transform transform, float startPos, float EndPos)
    {
        return transform.DOLocalMoveZ(EndPos, 0.5f).From(startPos).SetEase(Ease.InQuart);
    }
